...
* **tydiverse** ver.`r packageVersion("tidyverse")` por los paquetes que incluye para ayudar en la extracción y manipulación de la información en tablas y los gráficos mejorados de **ggplot2** ver.`r packageVersion("ggplot2")`. (5) y (6)
