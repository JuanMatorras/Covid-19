...
**NOTA:** Este gráfico ha permitido detectar un problema en los datos de origen que se está manifestando en los primeros días de 2021. Están apareciendo casos declarados en los primeros días de 2020 que antes no existían y que más que una revisión de datos antiguos puede ser un problema de deficiente registro de nuevos casos correspondientes a 2021 que se están dando de alta con fecha de 2020. Esperemos que esta deficiencia se detecte y corrija en los próximos días.
